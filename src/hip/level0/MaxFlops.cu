...
void RunBenchmark(ResultDatabase &resultDB, OptionParser &op)
{
    ...
    hipLaunchKernelGGL(HIP_KERNEL_NAME(MulMAdd2), dim3(blocks), dim3(threads), 0, 0, gpu_mem, 10, 3.75f, 0.355f);
    hipEventRecord(stop, 0);
    hipEventSynchronize(stop);
//    CHECK_CUDA_ERROR();
...
*/
    ...
    for (int p = 0; p < passes; p++)
    {
        t = 0.0f;
        hipEventRecord(start, 0);
        hipLaunchKernelGGL(HIP_KERNEL_NAME(MAddU), dim3(blocks), dim3(threads),0,0,target_sp, val1, val2);
        hipEventRecord(stop, 0);
        hipEventSynchronize(stop);
        CHECK_CUDA_ERROR();
        hipEventElapsedTime(&t, start, stop);
        ...
        hipEventRecord(start, 0);
        hipLaunchKernelGGL(HIP_KERNEL_NAME(MulMAddU), dim3(blocks), dim3(threads), 0, 0, target_sp, val1, val2);
        hipEventRecord(stop, 0);
        hipEventSynchronize(stop);
        CHECK_CUDA_ERROR();
        hipEventElapsedTime(&t, start, stop);
    ...
    if (doDouble)
    {
        ...
        for (int p = 0; p < passes; p++)
        {
            ...
            hipEventRecord(start, 0);
            hipLaunchKernelGGL(HIP_KERNEL_NAME(MAddU_DP), dim3(blocks), dim3(threads), 0, 0,target_dp, val1, val2);
            hipEventRecord(stop, 0);
            hipEventSynchronize(stop);
            CHECK_CUDA_ERROR();
            hipEventElapsedTime(&t, start, stop);
			...
			hipEventRecord(start, 0);
            hipLaunchKernelGGL(HIP_KERNEL_NAME(MulMAddU_DP), dim3(blocks), dim3(threads), 0, 0, target_dp, val1, val2);
            hipEventRecord(stop, 0);
            hipEventSynchronize(stop);
            CHECK_CUDA_ERROR();
            hipEventElapsedTime(&t, start, stop);
        ...
        const char* precision)
{
    ...
    for (int pass=0 ; pass<npasses ; ++pass)
    {
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(Add1), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(10.0));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(Add2), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(10.0));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(Add4), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(10.0));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(Add8), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(10.0));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(Mul1), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(1.01));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(Mul2), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(1.01));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(Mul4), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(1.01));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(Mul8), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(1.01));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(MAdd1), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(10.0), T(0.9899));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(MAdd2), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(10.0), T(0.9899));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(MAdd4), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(10.0), T(0.9899));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(MAdd8), dim3(blocks), dim3(threads), 0,0, gpu_mem, realRepeats, T(10.0), T(0.9899));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(MulMAdd1), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(3.75), T(0.355));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(MulMAdd2), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(3.75), T(0.355));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(MulMAdd4), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(3.75), T(0.355));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
       ...
       t = 0.0f;
       hipEventRecord(start, 0);
       hipLaunchKernelGGL(HIP_KERNEL_NAME(MulMAdd8), dim3(blocks), dim3(threads), 0, 0, gpu_mem, realRepeats, T(3.75), T(0.355));
       hipEventRecord(stop, 0);
       hipEventSynchronize(stop);
       CHECK_CUDA_ERROR();
       hipEventElapsedTime(&t, start, stop);
